...
public class EmployeeMainApp extends Application 
{
	...
	public void initRootLayout() 
	{
        try 
        {
            ...
            loader.setLocation(EmployeeMainApp.class.getResource("../view/RootLayout.fxml"));
	...
	public void showClaimAffairView() 
	{
        ...
        {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(EmployeeMainApp.class.getResource("../view/ClaimAffairView.fxml"));
	...
	public void showClaimInformationView(Claim claim) 
	{
        ...
        {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(EmployeeMainApp.class.getResource("../view/ClaimInformationView.fxml"));
	...
	public void showClaimNoticeView() 
	{
        ...
        {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(EmployeeMainApp.class.getResource("../view/ClaimNoticeView.fxml"));
