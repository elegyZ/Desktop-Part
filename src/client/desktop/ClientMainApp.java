...
public class ClientMainApp extends Application 
{
	...
	public void initRootLayout() 
	{
        try 
        {
            ...
            loader.setLocation(ClientMainApp.class.getResource("../view/RootLayout.fxml"));
	...
	public void showInsuranceClaimView() 
	{
        ...
        {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(ClientMainApp.class.getResource("../view/InsuranceClaimView.fxml"));
	...
	public void showClaimApplicationView(String policyId) 
	{
        ...
        {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(ClientMainApp.class.getResource("../view/ClaimApplicationView.fxml"));
	...
	public void showClaimApplicationCheckView(Claim claim) 
	{
        ...
        {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(ClientMainApp.class.getResource("../view/ClaimApplicationCheckView.fxml"));
	...
	public void showClaimNoticeView() 
	{
        ...
        {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(ClientMainApp.class.getResource("../view/ClaimNoticeView.fxml"));
